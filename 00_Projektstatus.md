...
Die Einträge **Fleisch**, **Gemüse & Salat** und **Vegan** verweisen auf eigene Übersichtsseiten.
...
- zeigt den Hinweis „Noch keine Rezepte“ und ist für spätere vegane Rezepte vorbereitet
...
- Hauptnavigation und relevante Hamburger-Menüs auf `vegan.html` umgestellt
- Buchversion auf 2.3.0 erhöht

## Offene Aufgaben

1. Grundlagen aus `kochbuch.html` in eine eigene Seite überführen.
2. Fleischrezepte schrittweise ausarbeiten und aus den Unterkategorien verlinken.
...
- Vegan-Links auf Startseite, Fleisch-Seite, Gemüse-&-Salat-Seite und den beiden vorhandenen Rezeptseiten auf `vegan.html` umgestellt
